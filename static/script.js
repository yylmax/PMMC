const questions = [
  ...
  "The _____, also known as sea lion, has external ear flaps, long foreflippers, and the ability to walk on all fours."
	...
	"Do sea lions have ear flaps or just holes for ears on their head?",
	"What is the bump that adult males develop on top of their head when they are mature?",
	"Are females bigger than males? Yes or No",
	"How long to sea lion moms nurse their pups: 1 month, 6-11 months, 2 years?",
	"What color are female sea lions when dry?",
...
const answers = [
                ...
                "Front", "On All 4 Flippers", "Ear Flaps", "Sagittal Crest", "No", "6 To 11 Months",
