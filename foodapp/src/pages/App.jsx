      ...
      <div>
        <div className="container-md text-center">
          ...
          <div className="container">
            <h2 className="title">
              Help Protect Marine Mammals and the Ocean!
            </h2>
            <p className="intro">
            ...
            <ul className="tips-list">
              ...
              <li className="tip">
                ...
                <span className="tip-text">
                  Encourage your family to carpool, ride bikes, or walk places
                  to keep the planet cooler and the ocean cleaner!
                </span>
              </li>
              <li className="tip">
                <span className="tip-number">5</span>
                <span className="tip-text">
                  Create a club at school that helps people learn about the
                  ocean, does beach clean-ups, or raises money and supplies for
                  places that help like PMMC!
                </span>
              </li>
            </ul>
          </div>
